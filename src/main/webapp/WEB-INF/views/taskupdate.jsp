...
%> 
					...
					<div class="row" id="parentEleDiv">
						<div class="form-group col-12 mb-5">
							<label class="form-label font-weight-website"><b
								...
								field</label>
								 ...
								 <h3 class="text-center mt-4">Update Task</h3>
						...
						<div class="position-relative">
							<label class="form-label font-weight-website"
								for="estStartDate">Planned Start Date<sup
								class="text-danger">*</sup></label> <input class="form-control"
						...
						<div class="position-relative">
							<label class="form-label font-weight-website"
								for="estEndDate">Planned End Date<sup
								class="text-danger">*</sup></label> <input class="form-control"
						...
						<div class="form-group col-12 col-md-4 mb-5">
    <label class="form-label font-weight-website" for="taskStatus">Task Status<sup class="text-danger">*</sup></label>
    <select class="form-control" id="taskStatus" name="taskStatus">
        <c:choose>
            ...
            <c:when test="${task.taskStatus == 'canceled'}">
                <option value="inprogress">inprogress</option>
                <option value="completed">completed</option>
                <option value="canceled" selected>canceled</option>
                <option value="upcoming">upcoming</option>
            </c:when>
            <c:when test="${task.taskStatus == 'upcoming'}">
                <option value="inprogress">inprogress</option>
                <option value="completed">completed</option>
                <option value="canceled">canceled</option>
                <option value="upcoming" selected>upcoming</option>
						...
						<div class="form-group col-12 col-md-4 mb-5">
						<div class="position-relative">
							<label class="form-label font-weight-website" for="videolink">Remarks</label> <input class="form-control"
					...
					<div class="d-flex flex-row justify-content-end mr-5">
							<button class="btn custom-button font-weight-website zoom-ele"
								type="button" onclick="submitForm()">Update Status</button>
						</div>
				</form>
				</div>
