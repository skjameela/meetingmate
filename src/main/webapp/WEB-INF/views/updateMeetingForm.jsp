						...
						<div class="row" id="parentEleDiv">
							...
							<div class="form-group col-12 col-md-4 mb-5">
								...
								<select class="form-control"
									...
									<c:choose>
										<c:when test="${meeting.meetingStatus == 'Scheduled'}">
											<option value="Scheduled" selected>Scheduled</option>
											<option value="completed">completed</option>
											<option value="meeting canceled">meeting canceled</option>
										</c:when>
										...
										<c:when test="${meeting.meetingStatus == 'meeting canceled'}">
											<option value="Scheduled">Scheduled</option>
											<option value="completed">completed</option>
											<option value="meeting canceled" selected>meeting canceled</option>
										</c:when>
									</c:choose>
								</select>
							</div>
