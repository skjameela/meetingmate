...
%>
	...
	<div class="col-12 col-md-10  bg-all-forms">
     <form class="py-5 px-3" id="personalForm" action="createTask" method="post"
		 ...
		 <div class="form-group col-12 col-md-4 mb-5">
			<div class="position-relative">
				<label class="form-label font-weight-website" for="employeeId">Employee Id<sup class="text-danger">*</sup></label>
					<input type="text" class="form-control"
						aria-label="Search by Employee ID" id="search-input" name="employeeId" required/>
				<div class="autocomplete-suggestions position-absolute rounded"
									id="suggestions"></div>
				</div>
			...
			<div class="position-relative">
				...
				<label class="form-label font-weight-website" for="assign">Assign Employee Name<sup class="text-danger">*</sup></label>
					<input type="text" class="form-control"
						aria-label="Search by Employee name" id="search-input1" name="assignName" required/>
				<!-- </div> -->
				<div class="autocomplete-suggestions position-absolute rounded"
									id="suggestions1"></div>
				</div>
      ...
      <!--   <div class="form-group col-12 col-md-4 mb-5">
        ...
        <div class="form-group col-12 col-md-4 mb-5">
           <label class="form-label font-weight-website" for="description">Description<sup class="text-danger">*</sup></label>
           <input class="form-control" type="text" id="description" name="description" required/>
        </div>
        
        <div class="form-group col-12 col-md-4 mb-5">
           <label class="form-label font-weight-website" for="estStartDate">Planned Start Date<sup
        ...
        <div class="text-center">
        	<input class="btn custom-button font-weight-website zoom-ele"
								type="submit" onclick="submitForm()" value="Create Task"/>
        </div>
...
<script src="https://cdn.jsdelivr.net/npm/pikaday/pikaday.min.js"></script>
	...
	<!------------------- jQuery for getting suggestions to empid from usertable --------------------------->
			...
			var searchInput_11=document.getElementById('search-input1');
    ...
    $(document).ready(function(){
    	...
    	var minu=dtToday.getMinutes();
    	if(minu<10) minu='0'+minu.toString();
    	var maxDate=year+'-'+month+'-'+day+' '+hours+':'+minu;
    	//consile.log(maxDate);
    	console.log(maxDate);
    	$('#estStartDate').attr('min',maxDate);
    });
