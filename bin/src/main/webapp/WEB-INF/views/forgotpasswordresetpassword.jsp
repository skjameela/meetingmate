						...
						<div class="py-2 px-3 shadow rounded">
							...
							<form action="/forgotpasswordpasswordreset" method="post">
								...
								<div class="form-group mb-4">
									...
									<label class="form-label font-weight-website" for="enterPassword">Enter
										password<sup class="text-danger">*</sup></label> <input class="form-control" type="password"
										id="enterPassword" name="enterPassword" required
