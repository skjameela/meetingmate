 ...
 <!-- footer section  -->
        <div class="row footer-bg-container">
          ...
          <div class="col-12 col-md-4 text-center pt-4 mb-2 zoom-ele">
            ...
            <i class="fa-solid fa-map-location icon1"></i><span class="contactdetails pl-2"> Unispace Building,1st floor Plot
              No.47 48,49,
              <br>Street Number 1, Street 2, Patrika Nagar, Madhapur, Telangana 500081</span>
          </div>
