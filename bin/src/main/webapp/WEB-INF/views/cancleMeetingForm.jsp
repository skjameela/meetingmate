        ...
        <div class=" col-12 col-md-10 bg-all-forms">
            ...
            <div class="mb-3">
                ...
                <div class="form-check" style="display: none;" id="updateMasterMeetingOptionId">
                    ...
                    <label class="form-check-label" for="updateMasterMeetingOption">Cancle Meeting</label>
                </div>
                <div class="form-check" style="display: none;" id="updateFollowUpMeetingOptionId">
                    ...
                    <label class="form-check-label" for="updateFollowUpMeetingOption">Cancle Recurrence Meeting</label>
                </div>
            </div>
...
%> 
        ...
        <h3 class="text-center mt-4">Cancle Recurrence Meeting</h3>
